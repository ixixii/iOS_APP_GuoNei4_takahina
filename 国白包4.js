...
1.2 开发者网站上面 创建证书  √
    ...
    2.只创建 生产证书dis 就行，开发可以用通用的net.vwhm.shinchan
    3.下载证书，双击导入

// 1.3 添加真机设备？算了，直接用模拟器算了 （可以略过） 

1.4 开发者网站上，创建应用ID，即注册appid 
    com.beyond.takahina (瞎.J.B.乱取的)
...
【TAKAHINA】家庭账号管理
https://shimo.im/docs/6GPTwkV63cqCpqGv
此时，再将url地址 https://shimo.im/docs/6GPTwkV63cqCpqGv，填回itunesconnect
--------------------------
// todo list 3: Logo √
